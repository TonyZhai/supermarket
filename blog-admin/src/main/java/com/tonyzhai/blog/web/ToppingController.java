...
public class ToppingController {
	...
	public String create(@Valid Topping topping, BindingResult bindingResult,
		...
		return "redirect:/toppings/"
				+ encodeUrlPathSegment(topping.getId().toString(),
						httpServletRequest);
	}
	...
	public String list(
		...
		if (page != null || size != null) {
			...
			final int firstResult = page == null ? 0 : (page.intValue() - 1)
					* sizeNo;
			uiModel.addAttribute("toppings",
					Topping.findToppingEntries(firstResult, sizeNo));
	...
	public String update(@Valid Topping topping, BindingResult bindingResult,
			Model uiModel, HttpServletRequest httpServletRequest) {
		if (bindingResult.hasErrors()) {
			populateEditForm(uiModel, topping);
